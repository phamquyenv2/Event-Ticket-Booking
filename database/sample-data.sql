...
(3, 'Anh Trai Say Hi - Live Concert 2026', 'Super Concert hội tụ dàn Anh Trai bùng nổ sân khấu, âm thanh ánh sáng chuẩn quốc tế!', 'Sân Vận Động Quốc Gia Mỹ Đình, Hà Nội', 15000, 'PUBLISHED', '2026-01-01 00:00:00', '2027-12-31 23:59:59', '2027-10-20 19:30:00', NOW(), NOW()),
(4, 'Anh Trai Vượt Ngàn Chông Gai - Tinh Hà Say Hi Tour', 'Đêm đại nhạc hội Tinh Hà rực rỡ, sống lại những khoảnh khắc thanh xuân cùng 33 Anh Tài!', 'Công Viên Lịch Sử Văn Hóa Dân Tộc, TP.HCM', 20000, 'PUBLISHED', '2026-01-01 00:00:00', '2027-12-31 23:59:59', '2027-11-15 19:00:00', NOW(), NOW());
...
(4, 3, 'SVIP Diamond', 'Hàng ghế SVIP trung tâm sân khấu + Bộ quà Say Hi đặc biệt', 3500000.00, 500, 500, 4, NOW(), NOW()),
(5, 3, 'VIP Gold', 'Khu vực VIP sát sân khấu', 2200000.00, 1500, 1500, 4, NOW(), NOW()),
(6, 3, 'GA Fanzone Standing', 'Khu vực đứng Fanzone quẩy cực nhiệt', 1500000.00, 5000, 5000, 4, NOW(), NOW()),
(7, 3, 'Standard Khán Đài', 'Khán đài A/B góc nhìn đẹp', 800000.00, 8000, 8000, 4, NOW(), NOW()),
(8, 4, 'VIP Tinh Hà', 'Vé VIP khán đài chính + Set quà lưu niệm Tinh Hà', 4000000.00, 1000, 1000, 4, NOW(), NOW()),
(9, 4, 'Chông Gai Standing', 'Sân đứng quẩy tự do hòa cùng 33 Anh Tài', 1800000.00, 9000, 9000, 4, NOW(), NOW()),
(10, 4, 'Standard Phổ Thông', 'Khán đài phổ thông bao quát toàn bộ hiệu ứng Tinh Hà', 900000.00, 10000, 10000, 4, NOW(), NOW());
...
(3, 'SAYHI2026', 'PERCENTAGE', 15.00, 500000.00, 1000000.00, 2000, 1, 0, 'ACTIVE', '2026-01-01 00:00:00', '2028-12-31 23:59:59', 3, NOW(), NOW()),
(4, 'TINHHA500K', 'FIXED_AMOUNT', 500000.00, NULL, 3000000.00, 100, 1, 0, 'ACTIVE', '2026-01-01 00:00:00', '2028-12-31 23:59:59', 4, NOW(), NOW());
